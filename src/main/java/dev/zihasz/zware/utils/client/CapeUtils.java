...
import dev.zihasz.zware.manager.CapeManager;
...
public class CapeUtils implements Util {
	...
	public static ResourceLocation downloadFromURL(URL url) throws MalformedURLException, IOException
	{
		return Minecraft.getMinecraft().getTextureManager().getDynamicTextureLocation("zware/capes", new DynamicTexture(ImageIO.read(url)));
	}
